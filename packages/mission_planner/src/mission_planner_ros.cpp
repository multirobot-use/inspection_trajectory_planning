...
MissionPlannerRos::MissionPlannerRos(ros::NodeHandle _nh) : nh_(_nh) {
  ...
  {
    cur_pose_sub_[i]      = nh_.subscribe<geometry_msgs::PoseStamped>("/drone_"+std::to_string(i)+"/ual/pose", 1, std::bind(&MissionPlannerRos::uavPoseCallback, this, std::placeholders::_1, i)); 
    cur_vel_sub_[i]       = nh_.subscribe<geometry_msgs::TwistStamped>("/drone_"+std::to_string(i)+"/ual/velocity", 1, std::bind(&MissionPlannerRos::uavVelocityCallback, this, std::placeholders::_1, i)); 
  }
...
// Callbacks
void MissionPlannerRos::uavPoseCallback(const geometry_msgs::PoseStamped::ConstPtr &msg, int id){
...
void MissionPlannerRos::uavVelocityCallback(const geometry_msgs::TwistStamped::ConstPtr &msg, int id){
